//
//  AvatarImageViewModelTests.swift
//  GHFollowersTests
//
//  Created by winsen on 24/05/24.
//
...
class AvatarImageViewModelTests: XCTestCase {
    ...
    override func setUp() {
        ...
        viewModel = AvatarImageViewModel(networkManager: mockNetworkManager)
    }
